...
router.get('/getApiUrl', function(req, res, next) {
    var url = getConf().baseUrl + "/platalytics/api/version/developers_interface/process/"+CONFIGURATIONS.processId+"/smart_sink/"+CONFIGURATIONS.smartSinkId+"/?query=select%20*%20from%20TABLE"+CONFIGURATIONS.smartSinkId.toUpperCase()+"&sink_type=smart&start=0&rows=500&sink_profile=5804911c87b25b0e5b29653e&cluster_profile=5804911a87b25b0e5b29653b";
